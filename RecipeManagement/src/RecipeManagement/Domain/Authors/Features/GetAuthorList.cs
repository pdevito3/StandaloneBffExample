...
{
    public sealed class Query : IRequest<PagedList<AuthorDto>>
    {
    ...
    public sealed class Handler : IRequestHandler<Query, PagedList<AuthorDto>>
    {
        ...
        {
            var collection = _authorRepository.Query().AsNoTracking();
