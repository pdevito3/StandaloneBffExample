...
{
    public sealed class AddIngredientListCommand : IRequest<List<IngredientDto>>
    {
    ...
    public sealed class Handler : IRequestHandler<AddIngredientListCommand, List<IngredientDto>>
    {
