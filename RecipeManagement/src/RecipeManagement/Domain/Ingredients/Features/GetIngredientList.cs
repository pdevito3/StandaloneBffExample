...
{
    public sealed class Query : IRequest<PagedList<IngredientDto>>
    {
    ...
    public sealed class Handler : IRequestHandler<Query, PagedList<IngredientDto>>
    {
        ...
        {
            var collection = _ingredientRepository.Query().AsNoTracking();
